 ...
 * @generated
 */
public class DatabaseItemProvider extends NamedItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationalPackage.Literals.DATABASE__TABLES);
			childrenFeatures.add(RelationalPackage.Literals.DATABASE__TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalPackage.Literals.DATABASE__TABLES,
				 RelationalFactory.eINSTANCE.createTable()));

		newChildDescriptors.add
			(createChildParameter
				(RelationalPackage.Literals.DATABASE__TYPES,
				 RelationalFactory.eINSTANCE.createType()));
	}
